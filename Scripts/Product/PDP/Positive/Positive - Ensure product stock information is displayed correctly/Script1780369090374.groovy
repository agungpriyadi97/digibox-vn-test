...
WebUI.click(findTestObject('Product/PDP/iphone 12'))

WebUI.scrollToElement(findTestObject('Product/PDP/txtStockStatus'), 3)

WebUI.verifyTextPresent('Có sẵn', false)

WebUI.click(findTestObject('Product/PDP/btn_detail_pdp'))
