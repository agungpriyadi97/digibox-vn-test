...
'Input Password'
WebUI.setText(findTestObject('Authentication/Registration/input_password'), user.password)

'Klik Register'
WebUI.click(findTestObject('Authentication/Registration/btn_register'))

'Verify Success Registration'
WebUI.verifyElementText(findTestObject('Authentication/Registration/txt_succses'), 'Việc đăng ký của bạn đã thành công!')

WebUI.waitForElementVisible(findTestObject('Authentication/Login/btn_login'), 4)

WebUI.waitForElementPresent(findTestObject('Authentication/Login/btn_login'), 4)

WebUI.verifyElementPresent(findTestObject('Authentication/Login/btn_login'), 2)
