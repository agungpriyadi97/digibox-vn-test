...
'Input Email'
WebUI.setText(findTestObject('Authentication/Registration/input_email'), 'agungpriyadi7252#gmail.com')
...
WebUI.verifyTextPresent('Vui lòng nhập email hợp lệ', false)
