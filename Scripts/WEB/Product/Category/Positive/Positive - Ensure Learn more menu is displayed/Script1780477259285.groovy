...
WebUI.waitForElementVisible(findTestObject('WEB/Home/Header/Menu/Menu Learn more/submenu_iPhone_LearnMore'), 10)

WebUI.click(findTestObject('WEB/Home/Header/Menu/Menu Learn more/submenu_iPhone_LearnMore'))
